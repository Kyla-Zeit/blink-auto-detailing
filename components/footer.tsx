    ...
    <footer className="bg-card border-t border-border py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 mb-8"> {/* If want it centered: <div className="grid md:grid-cols-2 gap-10 md:gap-14 place-items-center text-center mb-8">*/}
            {/* Quick Links */}
            <div>
