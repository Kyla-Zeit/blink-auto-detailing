...
export default function AwardBadge() {
  // Used to replay the burst animation on every hover
  ...
  return (
    <>
      ...
      >
        ...
        {/* tiny sparkle burst that replays on hover */}
        <span key={replay} className="burst" />
      </button>

      <style jsx>{`
        /* soft shimmer that sweeps across */
        .shine {
        ...
        /* gentle float on the sparkles icon */
        .floaty {
        ...
        .burst {
          ...
          width: 6px;
          height: 6px;
          background: #f59e0b; /* matches your accent/yellow stars */
